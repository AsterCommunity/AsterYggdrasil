...
- `/dashboard` 工作台。
- `/dashboard/profiles` Minecraft profile 与 launcher/材质操作。
- `/dashboard/wardrobe` 当前用户材质库。
- `/dashboard/settings` 个人设置、会话和 passkey。
- `/dashboard/admin/*` 管理配置、用户、Minecraft profile、外部认证、审计、任务和关于页。
